          ...
          <div className="row justify-content-center">
            <div className="col-10 col-sm-8">
              <p id="first-paragraph">
                ...
                ffice holdings with the sale of an additional $528 million of
                ...
                office properties, including the creation and renovation of
                common and amenity spaces, the addition of cutting edge food
                venues; as well as the delivery of 1,162 state-of-the-art,
              ...
              <p>
                ...
                our multifamily subsidiary. Over the year, we converted even more
                of our minority-owned multifamily positions to wholly-owned; we
                now have just 542 remaining units for which Roseland holds a
                ...
                income upon completion and stabilization. Our residential pipeline,
                which now contains approximately 10,960 units, can prospectively
                add incremental revenue and net operating income upon completion
                and stabilization. Our growth in Roseland is being financed by
                cash flow, long-term, low-cost mortgages and through an equity
              ...
              <p>
                ...
                activation of the waterfront better positions both our office
                and residential assets as the preferred place to live,
                work and play in Jersey City.
              </p>
              <p>
                ...
                not an easy task but a necessary one as we initiate a more efficient
                approach to executing our plan and building a team that works
                together seamlessly for the future.
              </p>
              <p>
              ...
              <p>
                ...
                a very robust office leasing pace in 2016, activity on the waterfront
                slowed throughout 2017. There are many theories as to what has
                caused the slowdown—the uncertainty around tax reform; the concerns
                around the gubernatorial change in New Jersey; the uncertainty
                around the pace of potential deregulation and impact of the Trump
                presidency. Whatever the reason, there is no denying that we need
                to be more effective with our leasing efforts, as we ended the
                year with 87.6% occupancy throughout our core office portfolio.
                While the loss of occupancy is not acceptable to us, we remain
                positive about our prospects, given the quality of our assets
                and their exceptional locations.
              </p>
              <p>
                The great deal of work we’ve completed in the last 33 months has
                made a significant difference in the way we operate, and it has
                positively impacted our results. From the beginning, we took an
                aggressive approach to reaching our objectives. And while we have
                met and exceeded a number of our goals, we have not achieved the
                same level of success across the board.
              </p>
              <p>
                ...
                throughout our residential portfolio, and we’re taking a more deliberate
                approach to office leasing on the waterfront. We have multiple leasing
                prospects from the technology, advertising media and information,
                financial services and healthcare sectors. Employers see the strength
                of our location in that it provides class A space at a competitive
                price, with excellent transportation options and a large residential
                base for prospective employees, in particular the millennial workforce.
              </p>
              <p>
              ...
              <p>
                The path to success is not simply a straight line, but a winding journey.
                Sometimes the road takes an unexpected turn, and frequently the destination
                ...
                job in transforming our portfolio; and Andrew Marshall, our
                President and EVP of Development at Roseland, who is building
                one of the finest luxury multifamily portfolios in the country.
                As always, we thank you, our investors for all of your continued
                support.
              </p>
