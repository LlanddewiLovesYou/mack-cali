      ...
      <div>
        ...
        <div className='mobile-copy'>
          ...
          <ul className='bubble-list'>
            <li><div id='mob-orange' className='mobile-bubble'></div>
              <div className='mobile-bubble-copy'>The dramatically transformed promenade
                tastefully combines multi-use communal spaces, collaborative lounges and
                a stylish floating stage designated for events on the water.
              </div>
            </li>

          <li><div id='mob-aqua' className='mobile-bubble'></div>
            <div className='mobile-bubble-copy'>  With all-new infrastructure,
              superior connectivity and comprehensive updates inside and out,
              Harborside represents a best-in-class working community.
            </div>
          </li>
          ...
          <div className='mobile-bubble-copy'>Jersey City Ranks 5th for best public
             transportation in the U.S. &mdash;Business Insider
          </div>
        </li>
          </ul>
            ...
            <div className='mobile-copy'>
              ...
              <ul className='bubble-list'>
                <li><div id='mob-orange' className='mobile-bubble'></div>
                <div className='mobile-bubble-copy'>
                  Weehawken Ranked #1 Amongst Best Places to Raise a Family in
                  Hudson County —Niche Media 2018 Best Places
                </div>
              </li>

              <li><div id='mob-aqua' className='mobile-bubble'></div>
              <div className='mobile-bubble-copy'>West New York Earns Walk Score: 94 &mdash;Walk Score</div></li>

              <li><div id='mob-purple' className='mobile-bubble'></div>
                <div className='mobile-bubble-copy'>Roseland has more than 2,000
                  apartment units in the pipeline.
                </div>
              </li>
          </ul>
